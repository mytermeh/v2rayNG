...
object AppConfig {
    ...
    const val SUBSCRIPTION_DEFAULT_UPDATE_INTERVAL = "15" // Default is 15 minutes
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val APP_UPDATE_CHANNEL_NAME = "App Updates"
    const val APP_UPDATE_NOTIFICATION_ID = 9527

    const val PREF_LAST_UPDATE_CHECK = "pref_last_update_check"
    const val UPDATE_CHECK_INTERVAL_MS = 6 * 60 * 60 * 1000L // 6 hours
